...
export default function DevToolsPage() {
  return (
    <div className="p-8 max-w-4xl font-sans">
      ...
      <h1 className="text-4xl font-bold mb-4 tracking-tight text-white">Dev Tools</h1>
      ...
      <section className="space-y-6">
        <div className="flex items-center justify-between border-b border-white/10 pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-semibold text-white tracking-tight uppercase text-sm font-mono">Extensions</h2>
        ...
        <div className="grid grid-cols-1 gap-4">
          <Link
            ...
            className="group relative block p-6 sm:p-7 bg-white/[0.02] border border-white/10 hover:border-[#CBA6F7]/60 hover:bg-white/[0.05] transition-all duration-200 rounded-none"
          >
            <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div className="flex items-start gap-4 flex-1">
                ...
                <div className="space-y-2.5 flex-1">
                  ...
                  <h3 className="text-xl font-bold text-white group-hover:text-[#CBA6F7] transition-colors">
                  ...
                  <div className="flex flex-wrap gap-4 pt-1 text-xs font-mono text-white/40">
              ...
              <div className="flex items-center gap-2 text-xs font-mono font-semibold text-white/60 group-hover:text-white shrink-0 self-end md:self-center border border-white/10 px-3 py-2 bg-white/5 rounded-none group-hover:border-[#CBA6F7]/50">
